...
pred myIdea { 
    -- Any two different locations have different values in them
    all row1, col1, row2, col2: Int | {
        ((row1 != row2 or col1 != col2) 
         and some Game.initialState.board[row1][col1]) implies {
...
all p: Person | some p.spouse implies 
  reachable[p.spouse, p, parent1, parent2]
