...
There isn't always an easy-to-extract property for every unit test. But this idea---of encoding _goals_ instead of specific behaviors---forces us to start thinking critically about _what we want_ from a system. It's only a short hop from there to some of the real applications we talked about last time, like verifying firewalls or modeling the Java type system.
